...
select 
    ...
    LOGIN_HISTORY_ID as feature_2,
    COMBINED_SESSION_ID as feature_3,
    QUERY_ID as feature_4,
    DATABASE_ID as feature_5,
    ERROR_ID as feature_6,
    ROLES_ID as feature_7,
    SCHEMA_ID as feature_8,
    TAGS_ID as feature_9,
    COMBINED_USERS_ID as feature_10,
    COMBINED_WAREHOUSE_ID as feature_11,
    TABLE_ID as feature_12,
    QUERY_START_DT as feature_13,
    QUERY_END_DT as feature_14,
    QUERY_TIME_IN_SECS as feature_15,
    BYTES_SCANNED as feature_16,
    OUTBOUND_DATA_TRANSFER_BYTES as feature_17,
    INBOUND_DATA_TRANSFER_BYTES as feature_18,
    EXTERNAL_FUNCTION_TOTAL_SENT_BYTES as feature_19,
    COMPUTE_COST as feature_20,
    CLOUD_SERVICES_COST as feature_21,
    QUERY_COST as feature_22,
    CURRENCY as feature_23,
    '' as feature_24,
    '' as feature_25
from final